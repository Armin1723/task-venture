...
const PDFReport = ({darkMode}) => {
  ...
  return (
    <div className='max-sm:w-full md:w-1/2 px-4'>       
        ...
        <form  className="max-w-screen-lg mx-auto p-4 border-2 border-blue-600/60 rounded-md py-6" onSubmit={(e)=>generateReport(e,formData)}>
            ...
            <div  className="relative z-0 w-full my-8 group">
                <input 
                    ...
                    className={`${darkMode && 'text-gray-100'} block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 focus:outline-none focus:ring-0 focus:border-blue-600 peer `} 
                    placeholder=" " 
                    required 
                />
                <label htmlFor="email"  className="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-8 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-8">Email address</label>
            </div>
            ...
            <div  className="grid md:grid-cols-2 md:gap-6">
                <div  className="relative z-0 w-full mb-8 group">
                    <input 
                        ...
                        onChange={handleChange} 
                        className={`${darkMode && 'text-gray-100'} block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none focus:outline-none focus:ring-0 focus:border-blue-600 peer`} 
                        placeholder=" " 
                        required 
                    />
